export const skills = [
  {
    ...
    title: "Análisis de Datos & EDA",
    description: "Exploración y validación de datos, extracción de insights para la toma de decisiones",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 17l-5-5 5-5v3l-2 2 2 2v3zm8-10l5 5-5 5v-3l2-2-2-2V7z"/></svg>`,
    title: "Machine Learning",
    description: "Modelado predictivo con Python y scikit-learn, aplicado a problemas de negocio y optimización de procesos.",
  },
  {
    ...
    title: "Visualización & Reporting",
    description: "Dashboards en Power BI y Excel avanzado, con KPIs de negocio y storytelling de datos.",
  },
  {
    ...
    description: "Consultas avanzadas, validación de datos y reporting financiero/comercial en bases de datos relacionales.",
  },
  {
    ...
    description: "Experiencia en estrategia digital, SEO, dropshipping y gestión de contenidos orientados a conversión.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 18H6a4 4 0 010-8 5 5 0 019.9-1.5A4.5 4.5 0 1119 18z"/></svg>`,
    title: "Cloud & Big Data",
    description: "Procesamiento distribuido con Apache Spark y PySpark, despliegue en Microsoft Azure.",
  },
];
